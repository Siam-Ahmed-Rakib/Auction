  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        {emailSent ? (
          <div className="bg-white py-8 px-6 shadow-lg rounded-xl text-center space-y-4">
            ...
            <Link href="/auth/login" className="inline-block mt-4 text-blue-600 hover:text-blue-500 text-sm font-medium">
              Back to sign in
            </Link>
          </div>
        ) : (
        ...
        <div className="bg-white py-8 px-6 shadow-lg rounded-xl">
          ...
          <div className="mt-6">
            ...
            <button
              ...
              disabled={submitting}
              className="mt-4 w-full flex justify-center items-center gap-3 py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
            >
