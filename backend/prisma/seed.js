...
async function main() {
  ...
  const auction2 = await prisma.auction.create({
    data: {
      ...
      images: ['/images/meta-quest-3-white.jpg'],
      category: 'Electronics',
      condition: 'New',
      startPrice: 250.00,
      currentPrice: 325.00,
  ...
  const auction3 = await prisma.auction.create({
    data: {
      ...
      images: ['/images/meta-quest-3-box.jpg'],
      category: 'Electronics',
      condition: 'Pre-Owned',
      startPrice: 200.00,
      currentPrice: 325.00,
  ...
  const sampleItems = [
    { title: 'Vintage Rolex Submariner Watch', cat: 'Fashion', price: 5000 },
    { title: 'Gaming PC RTX 4090 Custom Build', cat: 'Electronics', price: 2500 },
    { title: 'Rare Pokemon Card Collection', cat: 'Collectibles and Art', price: 800 },
    { title: 'Nike Air Jordan 1 Retro High OG', cat: 'Fashion', price: 250 },
    { title: 'DJI Mavic 3 Pro Drone', cat: 'Electronics', price: 1500 },
    { title: 'Signed Baseball Collection', cat: 'Sports', price: 300 },
    { title: 'Dyson V15 Detect Vacuum', cat: 'Home & Garden', price: 400 },
    { title: 'Canon EOS R5 Mirrorless Camera', cat: 'Electronics', price: 3000 },
    { title: 'Antique Victorian Writing Desk', cat: 'Home & Garden', price: 1200 },
    { title: 'Samsung Galaxy S24 Ultra 512GB', cat: 'Cell Phones & Accessories', price: 900 },
    { title: 'Bose QuietComfort Ultra Headphones', cat: 'Electronics', price: 300 },
    { title: 'Louis Vuitton Speedy Bandouliere 25', cat: 'Fashion', price: 1500 }
  ];
